...
<body>
    ...
    <h3 class="title">¡MOSTRAMOS NUESTRA GALERIA!</h3>
    
    <div class="container">
       
        <div class="card">
            <img src="images/images1.jpeg">
            <h4>Computadoras Fredy</h4>
            <p>Tecnologia Gamer</p>
            <a href="#">Leer más</a>
        </div>
        
        <div class="card">
            <img src="images/images3s.jpeg">
             <h4>Computadoras Fredy</h4>
            <p>Tecnologia Gamer</p>
            <a href="#">Leer más</a>
        </div>
        ...
        <div class="card">
            <img src="images/images4s.jpeg">
              <h4>Computadoras Fredy</h4>
            <p>Tecnologia Gamer</p>
            <a href="#">Leer más</a>
        </div>
         <div class="card">
             <img src="images/images5.jpeg">
           <h4>Computadoras Fredy</h4>
            <p>Tecnologia Gamer</p>
            <a href="#">Leer más</a>
        </div>
