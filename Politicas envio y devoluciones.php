...
<head>
    <meta charset="UTF-8">
    <title></title>
    <link rel="stylesheet" href="Estilopoliticasenviodevo.css">
    <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
</head>
<body>
    <br></br>
        <h1>POLITICAS DE ENVIO Y DEVOLUCIONES</h1>
                <br></br>
                   <header>
            <nav class="menu">
                <ul>
    ...
    <h3 class="title">¡POLÍTICAS DE ENVÍOS Y DEVOLUCIONES!</h3>
    
    <div class="container">
       
        <div class="card">
            <img src="imgss/polienv.png
                 ">
        ...
        <div class="card">
            <img src="imgss/polie.png">
            <h4>Envios 100% Seguros</h4>
            <p></p>
        ...
        <div class="card">
            <img src="imgss/en.jpg">
               <h4>Envios Con Las Mejores Compañias</h4>
            <p></p>
