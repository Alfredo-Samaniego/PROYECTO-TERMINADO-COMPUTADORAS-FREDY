...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            <img src="imgss/contact.jpg
                 ">
            <h4>contactenos:</h4>
            <p>WhatsApp:8714346798</p>
            <p>Teléfono:8714346798</p>
            <p>Correo: compusfredy16@gmail.com</p>
            <a href="#">Leer más</a>
        </div>
        ...
        <div class="card">
            ...
            <p>Lunes a Viernes de 9am a 8pm </p>
            <p>Sábados de 9am a 3pm</p>
            <a href="#">Leer más</a>
        </div>
        
        <div class="card">
            <img src="imgss/contact.jpg">
            <h4>Por disposición oficial por motivo de COVID-19 nuestras tiendas se encuentran cerradas temporalmente</h4>
            <p></p>
            <a href="#">Leer más</a>
        </div>
