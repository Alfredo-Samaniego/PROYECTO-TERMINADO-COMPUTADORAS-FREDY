...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            <img src="imgss/pre.jpg
                 ">
            <h4>¿Puedo encontrar las mismas promociones en tienda?</h4>
            <h4>¿Cuáles son los métodos de pago aceptados?</h4>
            <h4>¿Cuánto tiempo demora un reembolso?</h4>
            <p></p>
        ...
        <div class="card">
            <img src="imgss/pre.jpg">
                <h4>¿Cómo puedo comprar en línea?</h4>
                <h4>¿Cuál es el costo de mi envío?</h4>
                <h4>¿Manejan meses sin intereses?</h4>
                <p></p>
        ...
        <div class="card">
            <img src="imgss/pre.jpg">
             <h4>¿Cuánto tiempo puede tardar mi guía en dar rastreo?</h4>
             <h4>¿Cuál es el tiempo de entrega estimada de mi pedido?</h4>
             <h4>¿Cuánto tarda una PC Xtreme en enviarse?</h4>
             <p></p>
